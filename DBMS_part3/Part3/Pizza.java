...
public class Pizza 
{
	...
	private static String CrustTypeFromInt;
	private static String SizeFromInt;
	private String Size;
	private int OrderID;
	...
	public Pizza(int orderID,String size, String crustType,String pizzaDate)
	{
		CrustType = crustType;
		Size = size;
		OrderID = orderID;
	...
	public static String getPizzaSizeFromInt(Integer pizzaSize) {
		...
		pizzaSizeHash.put(1, "small");
		pizzaSizeHash.put(2, "medium");
		pizzaSizeHash.put(3, "large");
		pizzaSizeHash.put(4, "x-large");
	...
	public static String getPizzaCrustFromInt(Integer pizzaCrust) {
		...
		pizzaCrustHash.put(1, "thin");
		pizzaCrustHash.put(2, "original");
		pizzaCrustHash.put(3, "pan");
		pizzaCrustHash.put(4, "gluten free");
